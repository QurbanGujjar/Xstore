...
import sqlite3
# pip install pillow
class inventryManageClass:
    def inventryManage(self,root):
        # self.root=root
        ...
        self.cat_list=[]
        self.sup_list=[]
        inventryManageClass.fetch_cat_sup(self)
...
#==================Left Frame for Products Details=========
        left_fram=Frame(self.Main_frame,bd=2,relief=RIDGE,bg="white")
